...
def parse_args():
    ...
    parser.add_argument("--seed", type=int, default=1,
                        help="Range of seeds")
    parser.add_argument("--anno_path", type=str, default="/home/huemorgen/IFSDD/dataset/NEU_DET/annotations/instance_all.json",
                        help="annotation filepath")    
    parser.add_argument("--save_path", type=str, default="/home/huemorgen/IFSDD/dataset/NEU_DET/annotations/",
                        help="annotation filepath")    
