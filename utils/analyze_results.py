...
def main(args):
    ...
    cfg = SetDefectDataset(cfg,defect_data='NEU_DET',setting='SPLIT1_SEED1_30SHOT')
...
if __name__ == '__main__':
    ...
    args = argparse.Namespace(
        config = "/home/huemorgen/IFSDD/config/fine_tune/tfa_fine_tuning.py",
        cfg_options = None,
        prediction_path = "/home/huemorgen/IFSDD/pickles/tfa_preds_30shots.pkl",
        wait_time = 0,
        show =False,
        show_score_thr = 0,
        topk = 30,
        show_dir = "../results/analyze_tfa_mAP"
    )
