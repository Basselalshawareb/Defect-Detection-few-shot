...
if __name__=="__main__":
    ...
    for split in [1,2,3]:
        for shot  in [5,10,30]:
            ...
            path = f"/home/sunchen/Projects/DKAN/work_dir/DeepPCB/dkan/SPLIT{split}_SEED1_{shot}SHOT"

            # method_list = ["ifdd"]
            method = "dkan"
            # method_list = ["fsdetview"]
            
            show_dir = f"/home/sunchen/Projects/DKAN/visualization/SPLIT {split}/{shot}shot"

            # for method in method_list:
            result_folder = os.path.join(path,os.listdir(path)[0])
            file_list = os.listdir(result_folder)
            
            for file_name in file_list:   
                if "best" in file_name:
                    ckpt_path=os.path.join(result_folder,file_name)
                    break
            ...
            for file_name in file_list:
                ...
                if os.path.splitext(file_name)[-1] == ".py":
                    ...
                    cfg_path=os.path.join(result_folder,file_name)
