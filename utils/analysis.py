...
class ResultVisualizer:
    ...
    def _save_image_gts_results(self, dataset, results, mAPs, out_dir=None):
        ...
        for mAP_info in tqdm(mAPs):
            ...
            label_info = data_info["gt_labels"]
            ...
            imshow_gt_det_bboxes(
                ...
                results[index],
                dataset.CLASSES,
                gt_bbox_color="green", #dataset.PALETTE,
                gt_text_color=(200, 200, 200),
                gt_mask_color=dataset.PALETTE,
                det_bbox_color="red", #dataset.PALETTE,
    ...
    def _save_img_gt(self, dataset, out_dir=None):
        mmcv.mkdir_or_exist(out_dir)
...
if __name__ == '__main__':
    ...
    args = argparse.Namespace(
        config = "/home/huemorgen/IFSDD/config/fine_tune/dkan_fine_tuning.py",
        cfg_options = None,
        prediction_path = "/home/huemorgen/IFSDD/stage2results.pkl",
        wait_time = 0,
        show =False,
        show_score_thr = 0,
        topk = 90,
        show_dir = "/home/huemorgen/IFSDD/results/analysis"
    )
