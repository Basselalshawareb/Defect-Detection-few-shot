...
train_pipeline = [
    ...
    dict(
        type='Albu_with_print',
        transforms=[dict(type='Blur', blur_limit=(10, 15), p=1.0)],
        bbox_params=dict(
            type='BboxParams',
            format='pascal_voc',
...
data = dict(
    ...
    train=dict(
        ...
        data_root='datasets/NEU_DET/',
        ann_cfg=[
            dict(type='ann_file', ann_file='base/annotations/trainval.json')
        ],
        img_prefix='images',
        pipeline=[
            dict(type='LoadImageFromFile'),
    ...
    val=dict(
        type='FewShotDefectDataset',
        data_root='datasets/NEU_DET/',
        ann_cfg=[dict(type='ann_file', ann_file='base/annotations/test.json')],
        img_prefix='images',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
seed = 42
work_dir = './work_dirs/frcn_r101_augmented_base_training'
gpu_ids = range(0, 1)
