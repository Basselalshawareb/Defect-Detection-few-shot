...
data = dict(
    ...
    train=dict(
        ...
        save_dataset=False,
        data_root='/home/huemorgen/IFSDD/dkan/../dataset/NEU_DET/',
        ann_cfg=[dict(type='ann_file', ann_file='annotations/trainval.json')],
        img_prefix='images',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
    ...
    val=dict(
        type='FewShotDefectDataset',
        data_root='/home/huemorgen/IFSDD/dkan/../dataset/NEU_DET/',
        ann_cfg=[dict(type='ann_file', ann_file='annotations/test.json')],
        img_prefix='images',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
